...
class UnActiveChannelHomeList extends StatelessWidget {
  const UnActiveChannelHomeList({super.key, required this.channel});
              ...
              Column(
                ...
                children: [
                  RichText(
                    ...
                    TextSpan(
                      text: S.of(context).didnotpostpodcast,
                      style: TextStyle(
                        color: greyColor,
                        fontSize: 14.sp,
                        fontFamily:
            ...
            children: [
              TextButton(
                  onPressed: () => showDialog(
                      context: context,
                      builder: (context) =>
                          DeleteChannelMessage(channelId: channel.id!, active: true,)),
                  child: Text(
